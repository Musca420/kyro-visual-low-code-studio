...
| Canvas | Facilità Canva con potenza di programmazione completa | Spostare, ridimensionare, allineare, creare colonne/griglie e responsive senza codice; logica/dati restano visuali o Codex | Verificati: maniglie dirette, griglia 8 px, snapping intelligente a bordi/centri con guide, selezione a riquadro, 1–12 colonne per breakpoint con separatori trascinabili e tastiera, drag nelle colonne, multiselezione, allineamento/distribuzione, spostamento di gruppo, undo/redo, riapertura, preview ed export indipendente. I percorsi persona automatizzati sono verdi; la validazione con utenti umani resta esterna |
