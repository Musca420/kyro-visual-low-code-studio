...
| Canvas | Facilità Canva con potenza di programmazione completa | Spostare, ridimensionare, allineare, creare colonne/griglie e responsive senza codice; logica/dati restano visuali o Codex | Verificati: maniglie dirette, griglia 8 px, snapping a bordi/centri, selezione a riquadro, livelli trascinabili dentro/fuori dai contenitori, 1–12 colonne proporzionali per breakpoint, multiselezione, allineamento/distribuzione, spostamento di gruppo, undo/redo, riapertura, preview ed export. I percorsi persona automatizzati sono verdi; la validazione con utenti umani resta esterna |
