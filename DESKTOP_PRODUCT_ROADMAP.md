...
| Canvas | Facilità Canva con potenza di programmazione completa | Spostare, ridimensionare, allineare, creare colonne/griglie e responsive senza codice; logica/dati restano visuali o Codex | Verificati: maniglie dirette, snapping 8 px, guide, layout 1/2/3 colonne per breakpoint, drag nelle colonne, multiselezione, allineamento/distribuzione, spostamento di gruppo, undo/redo, riapertura, preview ed export indipendente. Restano snapping intelligente tra elementi, selezione a riquadro e sessioni persona complete |
