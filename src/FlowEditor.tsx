...
function FlowNode({ data }: NodeProps) {
  ...
  return <div className="flow-node" style={{ borderColor: colors[value.type] ?? '#64748b' }}>
    ...
    {value.type !== 'switch' && <Handle type="source" position={Position.Right} id="success" />}
