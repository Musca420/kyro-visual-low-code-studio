...
${dataRuntime}
type DataBinding = { componentId: string; sourceId: string; kind: string; metric: string; suffix: string; completion: 'streak' | 'status' | 'none'; editable: boolean; removable: boolean }
