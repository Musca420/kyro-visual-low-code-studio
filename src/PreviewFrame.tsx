...
function renderComponent(component: EditorComponent, children = "") {
  ...
  if (component.type === "input")
    return `<label>${escapeHtml(component.accessibility.label)}<input ${common} data-kind="input" placeholder="${escapeHtml(component.props.placeholder)}"></label>`;
  if (component.type === "button")
    return `<button ${common} data-kind="button" type="button"${component.props.disabled === true ? " disabled" : ""}>${text}</button>`;
  ...
  if (component.type === "textarea")
    return `<label>${escapeHtml(component.accessibility.label)}<textarea ${common}></textarea></label>`;
  if (component.type === "select")
    return `<label>${escapeHtml(component.accessibility.label)}<select ${common}><option>${text}</option></select></label>`;
  if (component.type === "checkbox" || component.type === "radio")
    return `<label><input ${common} type="${component.type}"> ${text}</label>`;
