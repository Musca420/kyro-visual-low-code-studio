...
type Props = {
  ...
  onRunFlow?: (flowId: string, input: unknown) => Promise<{ notification?: string; level?: string; navigate?: { path: string; mode: "page" | "back" | "url" }; modalId?: string; ui?: { componentId: string; operation: string; value: string } }>;
