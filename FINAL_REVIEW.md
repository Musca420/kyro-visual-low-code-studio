...
- `npm run check`: typecheck e lint senza errori, 12 file Vitest e 64 test superati, build Vite riuscita.
...
- `npx playwright test`: 40 test browser superati; 3 test dedicati saltati per variabili d'ambiente intenzionali.
