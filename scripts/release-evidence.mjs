...
const evidence = [
  ...
  "docs/benchmarks/2026-07-21-kyro-vs-repo.json",
  "docs/benchmarks/2026-07-21-kyro-vs-codex-cli-10-results.json",
  "docs/benchmarks/2026-07-21-kyro-10-raw.json",
  "docs/benchmarks/2026-07-21-codex-cli-10-raw.json",
  "docs/benchmarks/kyro-vs-codex-cli-10-prompts.json",
  "docs/images/kyro-vs-codex-cli-10.svg",
  "docs/images/kyro-benchmark-10-desktop.png",
  "docs/images/kyro-benchmark-10-mobile.png",
  "docs/images/kyro-2.1-fresh-install.png",
  "docs/images/kyro-android-build-verified.png",
  "docs/images/kyro-vs-repository-benchmark.svg",
  "docs/images/kyro-vs-repository-benchmark.png",
  "docs/images/kyro-global-capability-draft.png",
  "docs/images/kyro-live-codex-plan.png",
  "e2e/demo-a.spec.ts",
  "e2e/demo-b.spec.ts",
  "e2e/demo-c.spec.ts",
  "scripts/benchmark-codex-context.mjs",
  "scripts/benchmark-kyro-vs-cli-10.mjs",
  "scripts/benchmark-codex-cli-10.ps1",
  "scripts/report-10-prompt-benchmark.mjs",
